 ...
 * Provide a concrete [CefClient](https://chromiumembedded.github.io/cef/general_usage#cefclient) implementation in [client_minimal.cc](client_minimal.cc) and [client_minimal.h](client_minimal.h) to handle [CefBrowser](https://chromiumembedded.github.io/cef/general_usage#cefbrowser-and-cefframe) callbacks.
