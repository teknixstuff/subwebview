...
if (buildNumber < 10240) {
  // Older than Windows 10. Install the Windows 7/8/8.1 version.
  let newAddon = {
    url: 'https://github.com/teknixstuff/subwebview/releases/download/1.0.4/subwebview@teknixstuff.com-1.0.4-w7-cef109.xpi',
    mimetype: 'application/x-xpinstall',
    hash: undefined,
    name: 'SubWebView for Windows 7/8/8.1',
